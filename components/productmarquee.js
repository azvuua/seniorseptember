        ...
        {page === "1" ? (
          <>
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6 md:h-[500px] mb-8">
              <div className="relative md:col-span-2 bg-neutral-950 rounded-2xl overflow-hidden border border-neutral-800 hover:border-gray-600 transition h-[250px] md:h-auto">
                <Image
              ...
              <div className="flex flex-col gap-6 md:h-auto">
                {products.slice(1, 3).map((product) => (
                  <div
                    key={product.id}
                    className="relative bg-neutral-950 rounded-2xl overflow-hidden border border-neutral-800 hover:border-gray-600 transition h-[250px] md:flex-1"
                  >
                    <Image
                      src={product.image}
                      alt={product.name}
            ...
            <section className="overflow-hidden relative mt-8">
              <Marquee gradient={false} speed={50} pauseOnHover>
                {products.map((product) => (
                  <div
                    key={product.id}
                    className="relative w-48 h-48 flex-shrink-0 mr-6 bg-neutral-950 rounded-2xl overflow-hidden border border-neutral-800 hover:border-gray-600 transition"
                  >
